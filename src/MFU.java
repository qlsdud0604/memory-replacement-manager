...
class MFU extends JFrame {
	...
	/** constructor */
	public MFU(int numberOfFrame, int numberOfInput, int[] frame, int[] referenceString) {
		super("MFU Algorithm");
		...
		this.pageFrequency = new int[256];

		this.memory_layout = new int[numberOfFrame][numberOfInput];
	}

	/** show information of MFU Algorithm */
